...
import { PannierComponent } from 'app/entities/pannier/pannier.component';
import { PannierService } from 'app/entities/pannier/pannier.service';
import { Pannier } from 'app/shared/model/pannier.model';

describe('Component Tests', () => {
  describe('Pannier Management Component', () => {
    let comp: PannierComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PannierComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.panniers && comp.panniers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
